...
def dummy_station_ice_provisional_15min_nogap():  # approval_flag: str, qualifier_flag: str
    ...
    dataframe["dateTime"] = pd.to_datetime(
        dataframe["dateTime"].array, infer_datetime_format=True
    )
...
def test_mask_flag(dummy_station_ice_provisional_1Day_gap):
    assert (
        dummy_station_ice_provisional_1Day_gap._metadict.get("_mask_flag")
        == dummy_station_ice_provisional_1Day_gap.mask_flag
    )
